...
import { DataGrid, GridColDef, GridFilterInputValueProps, GridFilterItem } from "@mui/x-data-grid";
    ...
    return (
        <Box>
            <Stack direction={"row"} justifyContent={"space-between"}>
                <Button size="small" onClick={() => dispatch(openModal({ modalId: "createDoctor" }))}>
                    Create New Doctor
                </Button>
